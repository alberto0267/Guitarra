                  ...
                  <tr v-for="producto in carrito">
                    ...
                    <td class="flex align-items-start gap-4">
                      ...
                      <button
                        type="button"
                        class="btn btn-dark"
                        @click="$emit('incrementando-cantidad', producto.id)"
                      >
                        +
                      </button>
                    </td>
                    <td>
                      <button
                        ...
                        type="button"
                        @click="$emit('eliminar-guitarra', producto.id)"
                      >
                        X
                      </button>
                    </td>
